"main";let fs;_172‍.w("fs",[["default",["fs"],function(v){fs=v}]]);let path;_172‍.w("path",[["default",["path"],function(v){path=v}]]);let nodeBackToPromise;_172‍.w("./util",[["nodeBackToPromise",["nodeBackToPromise"],function(v){nodeBackToPromise=v}]]);let tap,mergeDeepRight;_172‍.w("ramda",[["tap",["tap"],function(v){tap=v}],["mergeDeepRight",["mergeDeepRight"],function(v){mergeDeepRight=v}]]);let unflatten;_172‍.w("flat",[["unflatten",["unflatten"],function(v){unflatten=v}]]);
...
let log = tap(_172‍.g.console.log)
...
walk('./node_modules/mozu-node-sdk/clients')
  ...
  .then(_172‍.g.console.log)
  .catch(_172‍.g.console.error)