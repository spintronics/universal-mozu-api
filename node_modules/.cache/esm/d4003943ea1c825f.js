"main";let fs;_ea1‍.w("fs",[["default",["fs"],function(v){fs=v}]]);let path;_ea1‍.w("path",[["default",["path"],function(v){path=v}]]);let nodeBackToPromise;_ea1‍.w("./util",[["nodeBackToPromise",["nodeBackToPromise"],function(v){nodeBackToPromise=v}]]);
  ...
  return new Promise((resolve, reject) => {
    fs.readdir(dir, (error, files) => {
      ...
      Promise.all(files.map((file) => {
        ...
        .catch(_ea1‍.g.console.log);
    });
  });
}

walk('./node_modules/mozu-node-sdk/clients').then(_ea1‍.g.console.log, _ea1‍.g.console.log)