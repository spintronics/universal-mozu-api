"main";let fs;_eb5‍.w("fs",[["default",["fs"],function(v){fs=v}]]);let path;_eb5‍.w("path",[["default",["path"],function(v){path=v}]]);let nodeBackToPromise;_eb5‍.w("./util",[["nodeBackToPromise",["nodeBackToPromise"],function(v){nodeBackToPromise=v}]]);
...
walk('./node_modules/mozu-node-sdk/clients').then(_eb5‍.g.console.log, _eb5‍.g.console.log)